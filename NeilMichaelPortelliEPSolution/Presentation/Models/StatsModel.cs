namespace NeilMichaelPortelliEPSolution.Presentation.Models
{
    public class StatsModel
    {
        ...
        public StatsModel(string title, string option1Text, string option2Text, string option3Text, int option1Votes, int option2Votes, int option3Votes, DateTime DateCreated)
        {
            Title = title;
